...
?>
  ...
  <TD 
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_ADD_SPECIAL_OFFER ?></B></FONT></td>
		<tr><td class=WIN>
...
<tr>
	<td>
		<?php  print TEXT_THIS_OFFER1 ?><input name="duration" value=0 size=3><?php  print TEXT_THIS_OFFER2 ?>
...
<?php  	$i=1;
	...
	{?>
		<tr align='right'>
		<td><?php  print local_date($date1[$i]) ?></td>
		<td><?php  print local_date($date2[$i]) ?></td>
		...
		<td><?php  print ($text[$i]) ?></td>
		<td>
		<?php  print  "<a href=\"javascript:do_change('$special[$i]')\">Replace</a>

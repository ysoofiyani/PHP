...
<script language="JavaScript">
	function del_corp( corp_id, corp_name ) {
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_CORPORATE_PARTNERS ?></B></FONT></td>
		<tr><td class=WIN>


<FONT size=5 color=#cc9900>&nbsp;<B><?php  print TEXT_CORPORATE_PARTNERS ?></B></FONT>
...
<tr>
	...
	<th><?php  print TEXT_MAX_BOOKING ?></th>
	<th><?php  print TEXT_ADDRESS ?></th>
	<th><?php  print TEXT_TEL ?></th>
	<th><?php  print TEXT_FAX ?></th>
	<th><?php  print TEXT_CONTACT_NAME ?></th>
	<th><?php  print TEXT_EMAIL ?></th>
	<th><?php  print TEXT_USERNAME ?></th>
	<th><?php  print TEXT_MANAGE ?></th>
</tr>
<?php
...
<br>	<input name="corp_name" value="<?php echo $row['name'];?>"><?php  print TEXT_NAME ?>
<br>	<input name="max_booking" size="3" value="<?php echo $row['max_booking'];?>"><?php  print TEXT_MAX_BOOKING ?>
<br>	<?php  print TEXT_ADDRESS ?><br><textarea name="address" rows=6 cols=40><?php echo $row['address'];?></textarea>
<br>	<input name="phone" value="<?php echo $row['phone'];?>"> <?php  print TEXT_TEL ?>
<br>	<input name="fax" value="<?php echo $row['fax'];?>"> <?php  print TEXT_FAX ?>
<br>	<input name="contact_name" value="<?php echo $row['contact_name'];?>"> <?php  print TEXT_CONTACT_NAME ?>
<br>	<input name="email" value="<?php echo $row['email'];?>"> <?php  print TEXT_EMAIL ?>
<br>	<input name="username" value="<?php echo $row['username'];?>"> <?php  print TEXT_USERNAME ?>
<br>	<input name="password" value="<?php echo $row['password'];?>"> <?php  print TEXT_PASSWORD ?>

<?php  if( $act=="change") {				?>
	<input type=hidden name="act" value="change_write">
	<input type=hidden name="id" value="<?php echo $row['corporate_id'];?>">
<?php  }else{						?>

...
?>
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_STAT ?></B></FONT></td>
		<tr><td class=WIN>
...
<?php
	...
	<select name="client">
		<option value="general"><?php  print TEXT_PUBLIC ?></option>
		<option value="corporate"><?php  print TEXT_CORPORATE ?></option>

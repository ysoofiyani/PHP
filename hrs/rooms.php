...
<h3><?php  print TEXT_YOUR_NAME ?></h3>
<table>
<tr>
	<td><?php  print TEXT_TITLE ?></td>
	<td>
		<select name="title">
			<option value="<?php  print TEXT_MR ?>"><?php  print TEXT_MR ?>
			<option value="<?php  print TEXT_MS ?>"><?php  print TEXT_MS ?>
			<option value="<?php  print TEXT_MS_MR ?>"><?php  print TEXT_MS_MR ?>
		</select>
	</td>
</tr>
<tr>
	<td><?php  print TEXT_FIRST_NAME ?>
</td><td><input name="first_name"></td>
</tr>
<tr>
	<td><?php  print TEXT_SURNAME ?></td><td><input name="surname"></td>
</tr>
</table>

<hr>
<h3><?php  print TEXT_ADDRESS ?></h3>
<table>
<tr valign="top">
	<td><?php  print TEXT_STREET_ADDRESS ?></td><td><textarea name="street_addr" cols=35 rows=6></textarea></td>
</tr>
<tr>
	<td><?php  print TEXT_CITY ?></td><td><input name="city"></td>
</tr>
<tr>
	<td><?php  print TEXT_STATE_PROVINCE ?></td>
	<td><input name="province"></td>
</tr>
<tr>
	<td><?php  print TEXT_ZIP_POSTAL_CODE ?></td><td><input name="zip"></td>
</tr>
<tr>
	<td><?php  print TEXT_COUNTRY  ?></td><td><input name="country"></td>
</tr>
</table>
<hr>

<h3><?php  print TEXT_CONTACT_INFO ?></h3>
<table>
<tr>
	<td><?php  print TEXT_TELEPHONE ?></td><td><input name="telephone"></td>
</tr>
<tr>
	<td><?php  print TEXT_FAX ?></td><td><input name="fax"></td>
</tr>
<tr>
	<td><?php  print TEXT_EMAIL ?></td><td><input name="email"></td>
</tr>
</table>
<hr>

<!--
<h3><?php  print TEXT_SPECIAL_REQUESTS  ?></h3>
<table>
<tr valign="top">
...
-->
	...
	<input type=hidden name="total_cost" value="<?php echo $summ;?>">

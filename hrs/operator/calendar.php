...
<tr>
	<td align=right>
		<font face="Goudy Old Style, Conneticut Gothic, Times New Roman" size=3 color=#cc9900><B><?php echo $date['month'];?>, <?php echo $date['year'];?></B></FONT>
		<table bgcolor="#CC9900">
			<tr><td><font color=black size=2><?php  print TEXT_SU  ?></font></td> <td><font color=black size=2><?php  print TEXT_MO ?></font></td> <td><font color=black size=2><?php  print TEXT_TU ?></font></td> <td><font color=black size=2><?php  print TEXT_WE ?></font></td> <td><font color=black size=2><?php  print TEXT_TH ?></font></td> <td><font color=black size=2><?php  print TEXT_FR ?></font></td> <td><font color=black size=2><?php  print TEXT_SA ?></font></td> </tr>
<?php
...
?>
	<td><font size=2><a href="javascript:cal_action(<?php echo $i;?>, <?php echo $curday['mon'];?>, <?php echo $curday['year'];?> );" style="text-decoration:none"><?php echo ($curday['wday']?"<font color=white>$i</font>":"<font color=red>$i</font>");?></a></td>

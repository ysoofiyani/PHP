...
?>
			...
			<BR><B><?php  print TEXT_HELLO ?><?php echo $corp_name;?><br>
			</FONT>
...
<?php  $res = mysql_query("SELECT * FROM Roomtypes where flag='on'");
		$i=1;
...
<table border=0 align="center">
	...
	<tr align="center">
		<TD></TD>
		<TD><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="2"  ><?php  print TEXT_DD ?></FONT></TD>
		<TD><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="2"  ><?php  print TEXT_MM ?></FONT></TD>
		<TD><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="2"  ><?php  print TEXT_YYYY ?></FONT></TD>
	</tr>
	<tr align="center">
	...
	<TR ALIGN="CENTER">
		<TD ALIGN="LEFT" COLSPAN="4"><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="3"  ><?php  print TEXT_USE_CALENDAR ?></FONT>
		</TD>
	</TR>
</table>
...
<table BORDER="0" ALIGN="CENTER">
	<TR ALIGN="CENTER">
		<TD></TD>
		 <?php  $i=1;
		    while ($i<$k)
  	          {?>
		  <TD><FONT FACE=Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="3"  ><a href=invent.php    onClick="openBrWindow('invent.php?room=<?php  print $id[$i] ?>'); return false;"><?php   print type($id[$i]) ?> </FONT></A></TD>
		  <?php  $i++; }?>
	</TR>
	<TR ALIGN="CENTER">
		<TD ALIGN="LEFT"><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE=3  ><B><?php  print TEXT_RATE_TODAY ?></B></FONT><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="3"  ><BR><CENTER>(<?php  print $d ?>)</CENTER></FONT></TD>
		 <?php  $i=1;
		    while ($i<$k)
  	          {?>
		<TD><?php echo $currency_euro;?><?php echo to_euro($rate[$id[$i]]) ?></TD>
		<?php  $i++; }?>
	...
	<TR ALIGN="CENTER">
		...
		?>
		<TD><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE="4"  ><B><?php  echo $adult[$id[$i]],"+",$child[$id[$i]]; ?></B></FONT></TD>
		<?php  } $i++; } ?>
		
	</TR>
	<TR ALIGN="CENTER">
		<TD ALIGN="LEFT"><FONT FACE="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE=3  ><B><?php  print TEXT_CHILD ?></B></FONT></TD>

...
?>
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_ROOM_INVENTORY ?></B></FONT></td>
		<tr><td class=WIN>
 ...
 <form>
	<input type="button" value="Back" onClick="document.location='inventory.php';">
       	...
       	<?php  $res = mysql_query("SELECT inventory FROM Roomtypes where id='$room'");
	...
	function openBrWindow(myUrl) {
 	...
 	<form name="adminForm" action="inventory.php?room=<?php  print $room ?>&edit=<?php  print 1 ?>" method="post">
        <TABLE BORDER="0" ALIGN="CENTER">
	<TR ALIGN="CENTER">
	<TD><?php  print TEXT_ROOM_INVENTORY ?></TD>
	</TR>
	<TR ALIGN="CENTER">
	<TD><TEXTAREA NAME="content" cols=50 rows=10><?php  print $invent ?></TEXTAREA></TD>
	</TR>
	<TR>
	<TD><A HREF=editor.htm  onClick="openBrWindow('editor.htm'); return false";><?php  print TEXT_VISUAL_EDITOR ?></a></TD>
	</TR>
        <TR>

...
<tr align="center" Valign="MIDDLE">
		<td >
			...
			<tr align=left valign=top>
				<td class="glow2" ><font face="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE=5 color=#cc9900><B><?php  print TEXT_HOTEL_SPECIAL_OFFERS ?></b></font>
				</td>
			</tr>
...
<?php
	...
	{?>
		...
		<tr>
		<td class=glow2  cospan=5><b><font face="Goudy Old Style, Conneticut Gothic, Times New Roman" SIZE=4><B><?php echo $text[$i] ?></B></font></td>
		</tr>
		<tr>
		<td class=glow2  align=right nowrap><b><?php  print TEXT_STARTS ?></td>
		<td class=glow2 nowrap><b><?php  echo local_date($date1[$i]) ?></td>
		<td class="glow2" align="right" nowrap><b><?php  print TEXT_ENDS ?></td>
		<td class="glow2" nowrap><b><?php echo local_date($date2[$i]) ?></td>
		</tr>             
		<tr align=center>
		<td></td>
		<?php  $m=1;
			   while ($m<$k)
  	        	  {?>
	                	<td class="glow2"><?php  print type($id[$m]) ?></td>
		<?php  $m++; } ?>
		</tr>
		<tr>
		...
		<?php  $m=1;
		 ...
		 <tr>
		 <td colspan=8><a class="glow2-href" href="special_offer_reserve.php?type=std&spec_id=<?php echo $special[$i] ?>"><?php  print TEXT_MAKE_BOOKING ?></a></td>
		</tr>
		</table>
		</td></tr>

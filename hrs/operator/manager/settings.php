...
<script language="JavaScript">
	function change( var_name, old_value ) {
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_SETTINGS ?></B></FONT></td>
		<tr><td class=WIN>
...
?>		<tr valign="top">
			...
			<td>
				<xmp><?php echo $row['text'];?></xmp>
			</td>
			<td>
				<a href="javascript:change( '<?php echo $row['name'];?>','<?php echo $row['text'];?>' )">Change</a>
			</td>
		</tr>
<?php 	}	?>
</table>

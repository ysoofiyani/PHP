...
?>
		...
		<tr><td bgcolor=navy><FONT class=a1 color=#ffffff>&nbsp;<B><?php  print TEXT_MAX_OCCUPANCY ?></B></FONT></td>
		<tr><td class=WIN>
...
<TABLE BORDER="0" ALIGN="CENTER">
	...
	<TR ALIGN="CENTER">
		<TD ALIGN="RIGHT"><B><?php  print TEXT_ADULT ?></B></TD>
		<?php  $i=1;
		    while ($i<$k)
  	          {
	...
	<TR ALIGN="CENTER">
		<TD ALIGN="RIGHT"><B><?php  print TEXT_CHILD ?></B></TD>
		<?php  $i=1;
		    while ($i<$k)
  	          {

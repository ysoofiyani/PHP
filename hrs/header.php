...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#442200" height="19">
    <td align="left" nowrap width=200><font size=2>&nbsp;&nbsp;<a href="index.php" class="glow"><b><?php  print TEXT_SYSTEM_RESERVATION ?></a></b></font></td>
    <td align="right" nowrap><font size=2 color=#ffffff><a href="https://www.safeweb.com/o/_:http://www.hrs.ricssoft.co.uk" class=glow><b><?php  print TEXT_SUPPORT ?></a> &nbsp;|&nbsp; <a href="index.php" class=glow><?php  print TEXT_SYSTEM_RESERVATION ?></a> &nbsp;|&nbsp; <a href="operator/index.php" class=glow><?php  print TEXT_ADMINISTRATION_PANEL ?></a>&nbsp;&nbsp;</b></font></td>
  </tr>
